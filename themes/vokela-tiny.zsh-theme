...
PROMPT=' %{$fg_bold[green]%}%n@%m:%{$fg[cyan]%}% $(_get_pwd_prompt_info) %{$fg_bold[blue]%}$(_virtualenv_prompt_info)$(_pyenv_prompt_info)$(_git_prompt_info)$(_hg_prompt_info)%{$fg_bold[blue]%}%
